import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as i,o as e}from"./app-BDqOilFQ.js";const l={};function p(c,s){return e(),a("div",null,s[0]||(s[0]=[i(`<h1 id="软件设计模式系列-第二期" tabindex="-1"><a class="header-anchor" href="#软件设计模式系列-第二期"><span>软件设计模式系列（第二期）</span></a></h1><blockquote><p>作者：老马<br><br>公众号：老马啸西风<br><br> 博客：<a href="https://houbb.github.io/" target="_blank" rel="noopener noreferrer">https://houbb.github.io/</a><br><br> 人生理念：知道的越多，不知道的越多，努力去学</p></blockquote><p>面对复杂的业务场景，千变万化的客户需求，如何以一变应万变，以最小的开发成本快速落地实现，同时保证系统有着较低的复杂度，能够保证系统后续de持续迭代能力，让系统拥有较高的可扩展性。</p><p><code>这些是一个合格的架构师必须修炼的基础内功，但是如何修炼这门神功？？？</code></p><p>我将常用的软件设计模式，做了汇总，目录如下：</p><div align="left"><img src="https://houbb.github.io/images/arch/designmodel/14-7.jpeg" width="400px"></div><p>(考虑到内容篇幅较大，为了便于大家阅读，将软件设计模式系列（共23个）拆分成四篇文章，每篇文章讲解六个设计模式，采用不同的颜色区分，便于快速消化记忆）</p><p><strong>前文回顾：</strong></p><ul><li><a href="https://mp.weixin.qq.com/s/cCPCWCpsJ0VceBQUIMuHPg" target="_blank" rel="noopener noreferrer">面对复杂业务架构，阿里架构师是如何做的？（第一期）</a></li></ul><p>本文是主要讲解<code>桥接模式</code>、<code>组合模式</code>、<code>装饰模式</code>、<code>门面模式</code>、<code>代理模式</code>、<code>责任链模式</code></p><h2 id="_1、桥接模式" tabindex="-1"><a class="header-anchor" href="#_1、桥接模式"><span>1、桥接模式</span></a></h2><p>自然界一般由实体和行为组成。当然为了提升系统的扩展性，它们两个又可以各自抽象，然后在抽象类中描述两者的依赖。</p><p><strong>定义：</strong></p><blockquote><p>将抽象部分与它的实现部分分离，使它们都可以独立地变化。</p></blockquote><p><strong>什么场景使用桥接模式？</strong></p><ul><li>一个类存在两个（或多个）独立变化的维度，且这两个（或多个）维度都需要独立进行扩展。</li><li>对于那些不希望使用继承或因为多层继承导致系统类的个数急剧增加的系统，桥接模式尤为适用。</li></ul><p><strong>核心思路：</strong></p><ul><li>抽象实体：定义的一种抽象分类。比如：人</li><li>具体实体：继承抽象实体的子类实体。比如：中国人、美国人、韩国人</li><li>抽象行为：定义抽象实体中具备的多种行为。比如：学汉语、吃汉堡</li><li>具体行为：实现抽象行为的具体算法。比如：中国人学汉语、美国人吃汉堡</li></ul><div align="left"><img src="https://houbb.github.io/images/arch/designmodel/15-1.jpg" width="600px"></div><p><strong>代码示例：</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>桥接模式是将抽象与抽象之间分离，具体实现类依赖于抽象。抽象的分离间接完成了具体类与具体类之间的解耦，它们之间使用抽象来进行组合或聚合，而不再靠多重继承来实现。<code>本质是将一个对象的实体和行为分离，然后再基于这两个维度进行独立的演化。</code></p><p><strong>适用场景：</strong></p><ul><li>拆分复杂的类对象时。 当一个类中包含大量对象和方法时，既不方便阅读，也不方便修改。</li><li>希望从多个独立维度上扩展时。 比如，系统功能性和非功能性角度，业务或技术角度等。</li><li>运行时，组合不同的组件</li></ul><h2 id="_2、组合模式" tabindex="-1"><a class="header-anchor" href="#_2、组合模式"><span>2、组合模式</span></a></h2><p><strong>定义：</strong></p><blockquote><p>组合模式也称整体模式，把一组相似的对象当作一个单一的对象，然后将对象组合成<code>树形结构</code>以表示整个层次结构。</p></blockquote><p>这里边有两个关键点：1、树形结构分层 2、业务统一化来简化操作</p><p><strong>核心思路：</strong></p><ul><li>抽象组件（AbstractNode）：定义需要实现的统一操作。</li><li>组合节点（CompositeNode）：抽象组件的衍生子类，包含了若干孩子节点（其它组合节点或叶子节点）。</li><li>叶子节点（LeafNode）：抽象组件的子类，但它的下面没有子节点。</li></ul><div align="left"><img src="https://houbb.github.io/images/arch/designmodel/15-2.jpg" width="600px"></div><p><strong>代码示例：</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>public abstract class AbstractNode {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>叶子节点不能新增、删除子节点，所以对应的方法为空。</p><p>组合模式本质上封装了复杂结构的内在变化，让使用者通过一个统一的整体来使用对象之间的结构。数据结构方面支持<code>树形结构</code>、<code>环形结构</code>、<code>网状结构</code>。如我们常见的 <code>深度优先搜索</code>、<code>广度优先搜索</code>都是采用这种模式。</p><p><strong>适用场景：</strong></p><ul><li>一组对象按照某种层级结构进行管理。如：管理文件夹和文件，管理订单下的商品。</li><li>需要按照统一的行为来处理复杂结构中的对象</li><li>快速扩展对象组合。</li></ul><div align="left"><img src="https://houbb.github.io/images/arch/designmodel/15-3.jpg" width="600px"></div><p>手机开始是按品牌来归属分类，现在业务增加价格维度分类，我们只需要引入新的分支节点，按新的维度构建组合关系。</p><h2 id="_3、装饰模式" tabindex="-1"><a class="header-anchor" href="#_3、装饰模式"><span>3、装饰模式</span></a></h2><p><strong>定义：</strong></p><blockquote><p>动态地向一个现有对象添加新的职责和行为，同时又不改变其结构，相当于对现有的对象进行包装。</p></blockquote><p><strong>核心思路：</strong></p><ul><li>抽象组件（Component）：装饰器基类，定义组件的基本功能</li><li>具体组件（ConcreteComponent）：抽象组件的具体实现</li><li>抽象装饰器（Decorator）：包含抽象组件的引用</li><li>具体装饰器（ConcreteDecorator）：抽象装饰器的子类，并重写组件接口方法，同时可以添加附加功能。</li></ul><div align="left"><img src="https://houbb.github.io/images/arch/designmodel/15-4.jpg" width="600px"></div><p><strong>代码示例：</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>public abstract class Component {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>按使用职责分为静态代理和动态代理。</p><ul><li>静态代理，代理类需要自己编写代码完成。</li><li>动态代理，代理类通过 Proxy#newProxyInstance(ClassLoader loader,Class&lt;?&gt;[] interfaces,InvocationHandler h) 方法生成。</li><li>JDK实现的代理中不管是静态代理还是动态代理，都是面向接口编程。CGLib可以不限制一定是接口。</li></ul><p><strong>优点：</strong></p><ul><li>职责清晰</li><li>高扩展，只要实现了接口，都可以用代理</li><li>智能化，动态代理</li><li>降低了对象的直接耦合</li></ul><p><strong>适用场景：</strong></p><ul><li>远程代理。无法直接操作远程对象。比如：Dubbo、gRPC，提供远程服务，客户端调用时需要走参数组装、序列化、网络传输等操作，这些通用逻辑都可以封装到代理中，客户端调用代理对象访问远程服务，就像调用本地对象一样方便。</li><li>保护代理。当客户端通过代理对象访问原始对象时，代理对象会根据规则判断客户端是否有权限访问。比如：防火墙</li><li>日志代理。比如：日志监控，正常业务访问时，调用代理，增加一些额外的日志记录功能。</li><li>虚拟代理，适用于延迟初始化，用小对象表示大对象的场景，减少资源损耗，提升运行速度。</li><li>不希望改变原对象，但需要增加类似于权限控制、日志、流控等附加功能时，可以使用代理模式。</li></ul><h2 id="_6、责任链模式" tabindex="-1"><a class="header-anchor" href="#_6、责任链模式"><span>6、责任链模式</span></a></h2><p><strong>定义：</strong></p><blockquote><p>责任链模式是一种行为设计模式，将所有请求的处理者通过前一对象记住其下一个对象的引用而连成一条链。收到请求后，每个处理者均可对请求进行处理，或将其传递给链中的下个处理者。</p></blockquote><p>责任链模式是对数据结构中的<code>链表</code>结构的具体应用。</p><p><strong>核心思路：</strong></p><ul><li>抽象处理者（Handler）：定义一个接口，内部包含处理方法和下一个节点的引用对象</li><li>具体处理者（ConcreteHandler）：<code>抽象处理者</code>的实现子类，判断本次请求是否处理，如果需要则处理，否则跳过，然后将请求转发给下一个节点。</li></ul><div align="left"><img src="https://houbb.github.io/images/arch/designmodel/15-7.jpg" width="600px"></div><p><strong>优点：</strong></p><ul><li>降低了对象之间的耦合度。链上各个节点各司其职，通过上下文传递数据，避免直接依赖。</li><li>增强系统的可扩展性。如果有新的业务需求，只需要在合适的位置增加一个链节点即可，满足开闭原则。</li><li>灵活性强。如果业务有变化，需要对工作流程做调整，只需要动态调整链上节点的次序即可。甚至为了满足多元化业务的多样化需求，我们可以为不同的业务类型定义自己的专属执行顺序。</li><li>简化了对象之间的连接。每个对象只需保存下一个节点的引用，而不需保持所有节点。</li><li>责任明确。每个节点只需处理自己的工作，如果不处理则传递给下一个对象。明确各类的责任范围，符合类的单一职责原则。</li></ul><p>像我们常见的网关架构推荐使用该模式，通过服务编排，可以自由地在任意位置添加或移除节点，满足一系列个性化功能。</p><div align="left"><img src="https://houbb.github.io/images/arch/designmodel/15-8.jpg" width="600px"></div><h2 id="写在最后" tabindex="-1"><a class="header-anchor" href="#写在最后"><span>写在最后</span></a></h2><p>设计模式很多人都学习过，但项目实战时总是晕晕乎乎，原因在于没有了解其核心是什么，底层逻辑是什么，《设计模式：可复用面向对象的基础》有讲过，</p><blockquote><p>在设计中思考什么应该变化，并封装会发生变化的概念。</p></blockquote><p><strong>软件架构的精髓：找到变化，封装变化。</strong></p><p>业务千变万化，没有固定的编码答案，千万不要硬套设计模式。无论选择哪一种设计模式，尽量要能满足<code>SOLID</code>原则，自我review是否满足业务的持续扩展性。有句话说的好，“不论白猫黑猫，能抓老鼠就是好猫。”</p><h1 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料"><span>参考资料</span></a></h1><ul><li><a href="https://kaiwu.lagou.com/course/courseInfo.htm?courseId=710&amp;sid=20-h5Url-0&amp;buyFrom=2&amp;pageId=1pz4#/detail/pc?id=6882" target="_blank" rel="noopener noreferrer">17 | 单例模式：如何有效进行程序初始化？</a></li><li><a href="https://www.liaoxuefeng.com/wiki/1252599548343744/1281319134822433" target="_blank" rel="noopener noreferrer">廖雪峰的官方网站</a></li></ul>`,100)]))}const r=n(l,[["render",p]]),o=JSON.parse('{"path":"/posts/arch/designmodel/%E8%BD%AF%E4%BB%B6%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F%E7%B3%BB%E5%88%97%EF%BC%88%E7%AC%AC%E4%BA%8C%E6%9C%9F%EF%BC%89.html","title":"软件设计模式系列（第二期）","lang":"zh-CN","frontmatter":{"title":"软件设计模式系列（第二期）","description":"软件设计模式系列（第二期） 作者：老马 公众号：老马啸西风 博客：https://houbb.github.io/ 人生理念：知道的越多，不知道的越多，努力去学 面对复杂的业务场景，千变万化的客户需求，如何以一变应万变，以最小的开发成本快速落地实现，同时保证系统有着较低的复杂度，能够保证系统后续de持续迭代能力，让系统拥有较高的可扩展性。 这些是一个合...","head":[["meta",{"property":"og:url","content":"https://houbb.github.io/interview/posts/arch/designmodel/%E8%BD%AF%E4%BB%B6%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F%E7%B3%BB%E5%88%97%EF%BC%88%E7%AC%AC%E4%BA%8C%E6%9C%9F%EF%BC%89.html"}],["meta",{"property":"og:site_name","content":"老马啸西风"}],["meta",{"property":"og:title","content":"软件设计模式系列（第二期）"}],["meta",{"property":"og:description","content":"软件设计模式系列（第二期） 作者：老马 公众号：老马啸西风 博客：https://houbb.github.io/ 人生理念：知道的越多，不知道的越多，努力去学 面对复杂的业务场景，千变万化的客户需求，如何以一变应万变，以最小的开发成本快速落地实现，同时保证系统有着较低的复杂度，能够保证系统后续de持续迭代能力，让系统拥有较高的可扩展性。 这些是一个合..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-08-16T11:28:53.000Z"}],["meta",{"property":"article:modified_time","content":"2025-08-16T11:28:53.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"软件设计模式系列（第二期）\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-08-16T11:28:53.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"老马啸西风\\",\\"url\\":\\"https://houbb.github.io\\"}]}"]]},"git":{"createdTime":1755343733000,"updatedTime":1755343733000,"contributors":[{"name":"bbhou","username":"bbhou","email":"1557740299@qq.com","commits":1,"url":"https://github.com/bbhou"}]},"readingTime":{"minutes":12.91,"words":3873},"filePathRelative":"posts/arch/designmodel/软件设计模式系列（第二期）.md","localizedDate":"2025年8月16日","excerpt":"\\n<blockquote>\\n<p>作者：老马<br>\\n<br>公众号：老马啸西风<br>\\n<br> 博客：<a href=\\"https://houbb.github.io/\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">https://houbb.github.io/</a><br>\\n<br> 人生理念：知道的越多，不知道的越多，努力去学</p>\\n</blockquote>\\n<p>面对复杂的业务场景，千变万化的客户需求，如何以一变应万变，以最小的开发成本快速落地实现，同时保证系统有着较低的复杂度，能够保证系统后续de持续迭代能力，让系统拥有较高的可扩展性。</p>","autoDesc":true}');export{r as comp,o as data};
